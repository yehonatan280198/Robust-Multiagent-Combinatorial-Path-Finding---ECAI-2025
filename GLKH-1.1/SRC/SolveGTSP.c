...
GainType SolveGTSP(int *GTour)
{
    ...
    sprintf(ProblemFileName, "/home/yonikid/Desktop/SimulatorAgents/pRobustCbss/GLKH-1.1/TMP/%s.atsp", Prefix);
    ...
    sprintf(ParFileName, "/home/yonikid/Desktop/SimulatorAgents/pRobustCbss/GLKH-1.1/TMP/%s.par", Prefix);
    assert(ParFile = fopen(ParFileName, "w"));
    fprintf(ParFile, "PROBLEM_FILE = /home/yonikid/Desktop/SimulatorAgents/pRobustCbss/GLKH-1.1/TMP/%s.atsp\n", Prefix);
    ...
    if (InitialTourFileName) {
        sprintf(NewInitialTourFileName, "/home/yonikid/Desktop/SimulatorAgents/pRobustCbss/GLKH-1.1/TMP/%s.initial.tour", Prefix);
    ...
    if (InputTourFileName) {
        sprintf(NewInputTourFileName, "/home/yonikid/Desktop/SimulatorAgents/pRobustCbss/GLKH-1.1/TMP/%s.input.tour", Prefix);
    ...
    for (i = 0; i < MergeTourFiles; i++) {
        sprintf(NewMergeTourFileName[i],
                "/home/yonikid/Desktop/SimulatorAgents/pRobustCbss/GLKH-1.1/TMP/%s.merge%d.tour", Prefix, i + 1);
    ...
    if (SubproblemTourFileName) {
        sprintf(NewSubproblemTourFileName, "/home/yonikid/Desktop/SimulatorAgents/pRobustCbss/GLKH-1.1/TMP/%s.subproblem.tour",
                Prefix);
    ...
    sprintf(TourFileName, "/home/yonikid/Desktop/SimulatorAgents/pRobustCbss/GLKH-1.1/TMP/%s.tour", Prefix);

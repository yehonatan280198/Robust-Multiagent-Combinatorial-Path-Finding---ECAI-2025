...
static GainType KOptimize(int *GTour)
{
    ...
    sprintf(ProblemFileName, "/home/yonikid/Desktop/SimulatorAgents/pRobustCbss/GLKH-1.1/TMP/%s.post.tsp", Prefix);
    ...
    sprintf(ParFileName, "/home/yonikid/Desktop/SimulatorAgents/pRobustCbss/GLKH-1.1/TMP/%s.post.par", Prefix);
